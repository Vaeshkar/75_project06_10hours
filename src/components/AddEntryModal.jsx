...
export default function AddEntryModal({ visible, onClose, handleSubmit, setIsLoading }) {
  return (
    <div className={`fixed inset-0 bg-black/60 flex justify-center items-center z-40 transition-opacity duration-700 ${
      ...
      <div className="min-h-[80vh] w-4/5 bg-yellow-400 p-8 flex flex-col justify-between rounded-[3rem]">
        <h2 className="text-xl font-bold text-black mb-4" style={{ fontSize: '6vw' }}>New Diary Entry</h2>
        <EntryForm
          onSubmit={(data) => {
            handleSubmit(data);
